    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 bg-black/30 flex items-center justify-center">
          <div className="bg-[#212121] w-full max-w-lg mx-auto rounded-xl p-10 shadow-lg relative">
            {/* Close Button */}
            <button
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-3 mt-2 text-white bg-neutral-900 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
